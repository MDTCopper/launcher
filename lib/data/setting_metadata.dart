...
/// 「常用」栏刻意留空，由 remote 数据的作者自行挑选（给键加上 common 分类即可）。
...
const List<SettingSpec> mindustrySettingCatalog = [
  ...
  SettingSpec.bool('hints', '游戏提示', [.game]),
  ...
  SettingSpec.bool('savecreate', '创建保存', [.game]),
  SettingSpec.intSlider(
    'saveinterval',
    '自动保存时间',
    [.game],
  ...
  SettingSpec.bool('detach-camera', '自由视角', [.graphics]),
  ...
  SettingSpec.bool('fps', '显示帧数和网络延迟', [.graphics, .info]),
  SettingSpec.bool('fullscreen', '全屏', [.graphics]),
  ...
  SettingSpec.bool('minimap', '显示小地图', [.graphics]),
  ...
  SettingSpec.bool('indicators', '敌人指示器', [.info]),
